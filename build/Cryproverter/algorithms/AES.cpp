...
AES::AES(int keyLen) : Engine ("", true)
{
  this->Nb = 4;
  switch (keyLen)
  {
...
unsigned char * AES::EncryptECB(const unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned int &outLen)
{
...
unsigned char * AES::DecryptECB(const unsigned char in[], unsigned int inLen, unsigned  char key[])
{
  inLen = (inLen / blockBytesLen) * blockBytesLen;      // Truncate to block size
...
unsigned char *AES::EncryptCBC(const unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned char * iv, unsigned int &outLen)
{
  outLen = GetPaddingLength(inLen);
  unsigned char *alignIn  = PaddingNulls(in, inLen, outLen);
  unsigned char *out = new unsigned char[outLen];
...
unsigned char *AES::DecryptCBC(const unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned char * iv)
{
  unsigned char *out = new unsigned char[inLen];
  unsigned char *block = new unsigned char[blockBytesLen];
  unsigned char *roundKeys = new unsigned char[4 * Nb * (Nr + 1)];
...
unsigned char *AES::EncryptCFB(const unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned char * iv, unsigned int &outLen)
{
  outLen = GetPaddingLength(inLen);
  unsigned char *alignIn  = PaddingNulls(in, inLen, outLen);
  unsigned char *out = new unsigned char[outLen];
...
unsigned char *AES::DecryptCFB(const unsigned char in[], unsigned int inLen, unsigned  char key[], unsigned char * iv)
{
  unsigned char *out = new unsigned char[inLen];
  unsigned char *block = new unsigned char[blockBytesLen];
  unsigned char *encryptedBlock = new unsigned char[blockBytesLen];
...
unsigned char * AES::PaddingNulls(const unsigned char in[], unsigned int inLen, unsigned int alignLen)
{
